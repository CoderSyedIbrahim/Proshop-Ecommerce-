...
# Load from env for production; fallback to the repo value for local dev.
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'sc%oco$+(3$z$at=z4j)#l-+ym)+_b11389mdt2^12m$bf63%@')
